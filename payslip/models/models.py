...
class Payslip_Step(models.Model):
    ...
    name = fields.Char('Name')
    code = fields.Char('Code')
    employee_id = fields.Many2one(comodel_name="college.employee", string="Employee", required=False, )
...
class Employee(models.Model):
    ...
    _inherit = 'college.employee'

    payslip_id = fields.Many2one(comodel_name="payslip.payslip.step", string="Payslip", required=False, )
